...
### Хеш-функция
**Хеш-функция** в данной работе - функция, преобразующая массив входных данных в беззнаковое целое число.
...
| Структура данных   	       |вставка | удаление | поиск |
|------------------------------|-------|----------|-------|
| Массив                       |O(N)   | O(N)     | O(N) |
| Список                       |   O(1)   | O(1)     | O(N) |
...
Как видно на рисунке, данные сначала обрабатываются хеш-функцией и по ее значению помещаются в список(бакет) под номером ```hash%N```, где $N$ число списков в таблице. При возникновении коллизий, элемент ищется в списке.
# Часть I
В первой части мы изучим все функции на заселенность, а потом выберем самую лучшую для использования в хеш-таблице и последующей оптимизации. Для тестирования будет использоваться текст У. Шекспира "Гамлет". Количество списков в таблице 5003.
## Хеш-функции
### Always1Hash
...
```
<details>
<summary>График заселенности хеш-фунции (кликабельно) </summary>
...
<details>
<summary>График заселенности (кликабельно) </summary>
...
| Version         |Time, sec| Time performance|Ticks performance | Relative time boost |
|-----------------|-------|--------------|---------| ------------------------|
| Not optimized   | 2.15 |      1      |   1    |        1 |
| Optimization 1  |  1.98 | 1,09      |   1,3  |      1.09
...
| Not optimized   | 2.15 |      1      |   1    |         1 |
| Optimization 1  | 1.98 | 1,09      |   1,3  |    1,09      |
| Optimization 2  | 1.60   | 1,34     |   3,12  | 1,24         |
...
<details>
<summary>Objdump of $findElementByValue$  (кликабельно) </summary>
...
<details>
<summary>Ассемблерный код оптимизированной функции  (кликабельно) </summary>
...
| Optimization 1  | 1.98 | 1.09      |   1.3  |       1.09 |
| Optimization 2  | 1.60   | 1.34     |   3.12  |    1.24 | 
| Optimization 3  |  1.60   | 1.34    |     3.19  | 1.24 |
...
| Version         |Time without 4 opt | Time with 4 opt | Performance boost |
|-----------------|-----------------|--------------------|-----------------|
| Not optimized   |    2.15           | 1.22            | 1.72 |
| Optimization 1  |  1.98           | 1.17            |  1.69 |
| Optimization 2  |1.60              | 0.9             | 1.78 |
| Optimization 3  |1.60            | 0.9             | 1.78|
